...
class _CreateAccountPageState extends State<CreateAccountPage> with AppValidatorsMixin {
                              ...
                              builder: (context, isVisible, _) {
                                return TextFieldWidget(
                                  ...
                                  onValidator: (value) => combineValidations([
                                    () => isNotEmpty(value),
                                    () => validatePassword(value),
                                    () => validateConfirmationPassword(value, password.text),
                                  ]),
                                );
                              }),
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              if (isValid) {
                                ...
                                cubit.createAccount(email: email.text, password: password.text);
                              }
                            },
