...
abstract class IProductRespository {
  AsyncResult<Unit, CustomException> create({required ProductEntity value});
  ...
  AsyncResult<List<ProductEntity>, CustomException> list({double? price, DateTime? date, orderBy});
}
